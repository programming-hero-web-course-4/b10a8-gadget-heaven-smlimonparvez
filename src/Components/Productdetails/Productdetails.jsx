...
const Productdetails = () => {
  ...
  return (
    <div className=" w-full bg-gradient-to-b from-transparent to-gray-100">
      ...
      <div className="w-4/5 md:w-3/5 ring ring-offset-1 bg-white ring-white rounded-xl relative bottom-26 p-5 left-2/4 transform -translate-x-1/2">
        <div className="flex gap-8">
          <div className="w-4/10 flex items-center">
            <img
              src={product_image}
              alt="Banner"
              className="w-full bg-center bg-cover rounded-xl"
            />
          </div>
